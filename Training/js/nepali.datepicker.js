...
$("#" + e).val(t);$("#" + e).trigger('change');hideCalendarBox();}function showCalendar(t){$("#ndp-nepali-box table").find("tr:gt(0)").remove(),""==t?$("#ndp-nepali-box table").append(getDateTable("")):$("#ndp-nepali-box table").append(getDateTable(t)),"block"==$("#ndp-nepali-box").css("display")&&$("#ndp-nepali-box").hide(),$("#ndp-nepali-box").fadeIn(100)}function getDateTable(t){if(""==t){var e=getNepaliDate(),s=getMonthParameters(e),a=getDateRows(s[0],s[1],s[2],s[3],s[4])
