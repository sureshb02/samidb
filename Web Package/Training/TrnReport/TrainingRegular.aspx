<%@ Page Title="" Language="C#" MasterPageFile="~/Trainings.Master" AutoEventWireup="true"
    CodeBehind="TrainingRegular.aspx.cs" Inherits="SaMI.Web.Training.TrnReport.TrainingRegular" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TrainingBody" runat="server">
    ...
    <div class="col-lg-12" style="margin-top: 8px; margin-left: 0px; overflow:scroll">
        <asp:Panel runat="server" ID="Panel1">
            <asp:GridView ID="gdvTrainingRegularReport" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover"
                AllowPaging="true" PageSize="20" OnPageIndexChanging="gdvTrainingRegularReport_PageIndexChanging"
