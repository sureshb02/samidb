<%@ Page Title="Edit | Free Legal and Paralegal Service" Language="C#" MasterPageFile="~/CaseMaster.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="SaMI.Web.FLAC.FLAPS.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:HiddenField ID="hfFLAC_FLPS_ProfileID" runat="server" Value="" />
    <asp:HiddenField ID="hfFLAC_FLPS_VictimDetailID" runat="server" Value="" />
    <asp:HiddenField ID="hfFLAC_FLPS_CaseDetailID" runat="server" Value="" />
    <asp:HiddenField ID="hfFLAC_FLPS_DestOpponentDetailID" runat="server" Value="" />
    <asp:HiddenField ID="hfFLAC_FLPS_RemediesID" runat="server" Value="" />

    <asp:HiddenField ID="hfFLAC_FLPS_CaseFETID" runat="server" Value="" />
    <asp:HiddenField ID="hfFLAC_FLPS_CaseSCID" runat="server" Value="" />
    <asp:HiddenField ID="hfFLAC_FLPS_CaseFEPBID" runat="server" Value="" />
    <asp:HiddenField ID="hfFLAC_FLPS_CaseECMFID" runat="server" Value="" />
