<%@ Page Title="Edit | Helath & Saftey" Language="C#" MasterPageFile="~/CaseMaster.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="SaMI.Web.FLAC.HealthNSaftey.Edit" %>
    ...
    <div class="container" style="margin-top:10px">
            <div class="row">
                ...
                <table id="recuritmentProcess" width="100%" cellpadding="5" cellspacing="0" border="0" class="table-tab">
                    ...
                    <tr>
		                <td width="18%"><label>Labor Approval No. Number:</label></td>
		                <td><asp:TextBox ID="txtLaborNumber" runat="server" CssClass="form-control input-sm"></asp:TextBox></td>
		                <td><label>Issued Date:</label></td>
		                <td><asp:TextBox ID="txtLaborNumberIssuedDate" runat="server" CssClass="form-control input-sm date_input"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td colspan="4">
                            <div class="liner">&nbsp;</div>
                    ...
                    <tr>
		                ...
		                <td width="15%"><label>Name of Medical Institute:</label></td>
                ...
                <table id="employmentInformation" width="100%" cellpadding="5" cellspacing="0" border="0" class="table-tab">
                    ...
                    <tr>
                        <td colspan="3">
                            <label>Does the person have a copy of the contact signed in Nepal?</label>
                        ...
                        <td colspan="3">
                            <label>Does the person have a copy of the contact signed in the destination country?</label>
                ...
                <table id="Table1" width="100%" cellpadding="5" cellspacing="0" border="0" class="table-tab">
                    ...
                    <tr>
                        <td width="25%"><label>Problem faced : nature of cases categories</label></td>
                        <td>
                            <asp:DropDownList ID="ddlNatureOfCases" runat="server" CssClass="form-control input-sm">
                                <asp:ListItem Value="">--Select--</asp:ListItem>
                                <asp:ListItem Value="Medical Fail">Medical Fail</asp:ListItem>
                                <asp:ListItem Value="Injuries in work place accident">Injuries in work place accident</asp:ListItem>
                                <asp:ListItem Value="Injuries in road accident">Injuries in road accident</asp:ListItem>
                                <asp:ListItem Value="Other accidents">Other accidents</asp:ListItem>
                                <asp:ListItem Value="Mental health">Mental health</asp:ListItem>
                                <asp:ListItem Value="Other health problems">Other health problems</asp:ListItem>
                                <asp:ListItem Value="Other">Other</asp:ListItem>
                            </asp:DropDownList>
                            <label>If others, please specify:</label>
                            <asp:TextBox ID="txtProblemFacedDetails" placeholder="" runat="server" CssClass="form-control input-sm"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div class="liner">&nbsp;</div>
                ...
                <table id="Table4" width="100%" cellpadding="5" cellspacing="0" border="0" class="table-tab">
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtMedicalNepalCertificateDate" runat="server" CssClass="form-control input-sm date_input"></asp:TextBox></td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td><asp:TextBox ID="txtIDCardDateOfIssue" runat="server" CssClass="form-control input-sm date_input"></asp:TextBox></td>
                        ...
                        <td colspan="2">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td><label>Date of issue:</label></td>
                                    <td><asp:TextBox ID="txtVisaDateOfIssue" runat="server" CssClass="form-control input-sm date_input"></asp:TextBox></td>
                                    <td><label>Duration of validity</label></td>
                        ...
                        <td colspan="2">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td><label>Date of issue:</label></td>
                                    <td><asp:TextBox ID="txtInsuranceDestDateOfIssue" runat="server" CssClass="form-control input-sm date_input"></asp:TextBox></td>
                                    <td><label>Duration of validity</label></td>
                            ...
                            <table width="100%" class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><asp:TextBox ID="txtDueSalaryDestReceivedDate" runat="server" CssClass="form-control input-sm date_input"></asp:TextBox></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:TextBox ID="txtInsuranceDestReceivedDate" runat="server" CssClass="form-control input-sm date_input"></asp:TextBox></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:TextBox ID="txtFEPBSourceReceivedDate" runat="server" CssClass="form-control input-sm date_input"></asp:TextBox></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:TextBox ID="txtInsuranceSourceReceivedDate" runat="server" CssClass="form-control input-sm date_input"></asp:TextBox></td>
                ...
                <table id="Table3" width="100%" cellpadding="5" cellspacing="0" border="0" class="table-tab">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <table width="100%">
                                <tr>
                                    <td width="20%">With Hospital/doctor/psychologist</td>
